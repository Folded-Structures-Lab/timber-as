nomenclature_AS1720 = {
    ...
    "k_12": ("Stability factor", "(Cl 2.4.6)"),
    "S3": (
        "Slenderness coefficient for compressive lateral buckling, major axis",
        "(Cl 3.3.2.2a)",
    ),
    "S4": (
        "Slenderness coefficient for compressive lateral buckling, minor axis",
        "(Cl 3.3.2.2a)",
    ),
}
